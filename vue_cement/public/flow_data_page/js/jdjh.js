...
//	chengGuoPlanTimeBucket: ['2017-12-07', '2017-12-14']
	...
	// 方案 实际时间段
	fangAnTimeBucket: ['2023-02-04', '2023-02-27'],
	// 方案 计划时间段
	fangAnPlanTimeBucket: ['2023-02-05', '2023-02-26'],
 
	// 纲要 实际时间段
	gangYaoTimeBucket: ['-', '-'],
	// 纲要 计划时间段
	gangYaoPlanTimeBucket: ['2023-02-27', '2023-03-07'],
 
	// 成果 实际时间段
	chengGuoTimeBucket: ['-', '-'],
	// 成果 计划时间段
	chengGuoPlanTimeBucket: ['2023-03-08', '2023-04-17']
